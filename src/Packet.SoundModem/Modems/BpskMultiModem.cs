...
public sealed class BpskMultiModem : IModem, IConstellationSource, IFrameSpanSource
{
        ...
        bool acceptPlainIl2p = false, PskDetector? secondDetector = null)
    {
        ...
        for (int i = 0; i < positions; i++)
        {
            ...
            if (perPosition == 2)
            {
                ...
                // exclusive frames, +1.1 % union - docs/dev/archive/rx-roadmap.md workstream 2), and
    ...
    /// <inheritdoc />
    /// <remarks>
    /// A branch's, because every branch is the same <see cref="BpskModem"/> at a different
