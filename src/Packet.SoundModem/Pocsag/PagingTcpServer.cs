...
/// TX-complete) via <see cref="SoundModemChannel.EnqueueTransmit(Func{int,float[]},Action{Exception},bool,object,System.TimeSpan?,System.Threading.CancellationToken,Func{bool},Action{int},Action{System.TimeSpan})"/>.
/// </summary>
/// <remarks>
