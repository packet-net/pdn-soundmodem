...
public class OfdmModulatorObwTests(ITestOutputHelper output)
{
    ...
    /// the 99 %-power edge can wobble a bin under the &lt;1 LSB waveform difference. datac4 and
    /// datac13 have no checked-in codec2 vector (see the modulator oracle notes); they remain
    /// covered by the pinned windows above and share datac14's BPF/centre code path.
    /// </summary>
    [Theory]
    [InlineData("datac0")]
    [InlineData("datac1")]
