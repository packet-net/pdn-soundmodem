...
| `ms110d-wn8` | 16QAM r3/4 | ⚠ **Partial** - AWGN on-air-proven at reachable SNR; Poor sim hard-gated since 2026-08-20 (12 / 18 per 4.3M bits, both families under the mask); no on-air Poor confirmation possible at +23 dB over either rig |
